...
A_long = [(M_q + ((Z_q+U_1)* M_alpha_dot)/(U_1-Z_alpha_dot) )    ((-sin(Theta_1)*g*M_alpha_dot)/(U_1-Z_alpha_dot))  (M_alpha + M_T_alpha + (Z_alpha*M_alpha_dot)/(U_1-Z_alpha_dot))  (M_u + M_T_u + (Z_u *M_alpha_dot)/(U_1 - Z_alpha_dot)); ...
          1 0 0 0;...
          ((Z_q + U_1)/(U_1 - Z_alpha_dot))                -((sin(Theta_1)*g)/(U_1 - Z_alpha_dot))        (Z_alpha/(U_1 - Z_alpha_dot))                                    (Z_u/(U_1 - Z_alpha_dot));...
...
% this matirx expects the state vector to be: [beta; Theta_dot; Theta; Psi_dot]
% and input vectors to be: [delta_a; delta_r]

A_1 = I_xz / I_xx;
B_1 = I_xz / I_zz;

A_lat = [ Y_beta/U_1,                                             Y_p/U_1,                           g*cos(Theta_1)/U_1,   (Y_r-U_1)/U_1; ...
