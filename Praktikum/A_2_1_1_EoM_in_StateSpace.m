...
A_long = [(M_q + (Z_q+U_1)/(U_1-Z_alpha_dot) * M_alpha_dot)    ((-sin(Theta_1)*g*M_alpha_dot)/(U_1-Z_alpha_dot))  (M_alpha + M_T_alpha + (Z_alpha*M_alpha_dot)/(U_1-Z_alpha_dot))  (M_u + M_T_u + (Z_u *M_alpha_dot)/(U_1 - Z_alpha_dot)); ...
          1 0 0 0;...
